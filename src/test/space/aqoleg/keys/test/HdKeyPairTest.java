...
class HdKeyPairTest {
    ...
    void test4() {
        ...
        assertThrows(NumberFormatException.class, () -> hdKeyPair2.generateChild("k0"));
    ...
    void deserializeTest() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> HdKeyPair.deserialize("unacceptedsymbol-"));
        assertThrows(UnsupportedOperationException.class, () -> HdKeyPair.deserialize("shirtmsg"));
        String xdrv = "xdrv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNN"
                + "U3TGtRBeJgk33yuGBxrMPHi";
        assertThrows(UnsupportedOperationException.class, () -> HdKeyPair.deserialize(xdrv));
        ...
        assertThrows(UnsupportedOperationException.class, () -> HdKeyPair.deserialize(xpub));
        ...
        assertThrows(UnsupportedOperationException.class, () -> HdKeyPair.deserialize(checksum));
    }
