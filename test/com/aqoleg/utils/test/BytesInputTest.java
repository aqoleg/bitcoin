...
public class BytesInputTest extends Test {

    public static void main(String[] args) {
        new BytesInputTest().testAll();
    }
    ...
    public void array() {
        ...
        assertEquals("", bytes.readBytes(new byte[0]));
        assertEquals(new byte[]{10, 20}, bytes.readBytes(new byte[2]));
        ...
        bytes1.readBytes(new byte[]{}, 0, 0);
        assertEquals(new byte[]{0, 0, 10, 20, 0}, bytes1.readBytes(new byte[5], 2, 2));
    ...
    public void readVariableLengthInt() {
    ...
    public void readVariableLengthString() {
        BytesInput bytes1 = new BytesInput(new byte[]{});
        ...
        byte[] bytes3 = new byte[]{(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF,
                (byte) 0xFF, (byte) 0xFF, (byte) 0x0f};
        assertThrows(IndexOutOfBoundsException.class, () -> new BytesInput(bytes3).readVariableLengthString());
