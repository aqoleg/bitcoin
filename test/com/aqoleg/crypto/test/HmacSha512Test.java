...
public class HmacSha512Test extends Test {

    public static void main(String[] args) {
        new HmacSha512Test().testAll();
    }
    ...
    public void getMac() {
        ...
        assertEquals(
                ...
                HmacSha512.getMac(("The quick brown fox jumps over the lazy " + Character.toString((char) 100) +
                        Character.toString((char) 111) + Character.toString((char) 103)).getBytes(), "key".getBytes())
        );
